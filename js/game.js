...
var shareTitle = 'I found CHARLIE in [SCORE]!';//social share score title
var shareMessage = 'Hey I found CHARLIE in [SCORE] on Find CHARLIE game! Challenge me now!'; //social share score message
...
function share(action){
	...
	if( action == 'twitter' ) {
		...
		shareurl = 'mailto:?subject=Can you find CHARLIE? &amp;body=Check out this site http://www.findCHARLIE.xyz'+loc;
	}
